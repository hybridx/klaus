...
class klausAgent:  # noqa: N801
    ...
    _SYSTEM_PROMPT = (
        ...
        "IMAGE ANALYSIS:\n"
        "• When the user shares an image, analyze it directly using your vision "
        "capabilities. Describe what you see in detail.\n\n"
        "CONVERSATION CONTEXT:\n"
        "• You have access to the full conversation history. Reference earlier "
